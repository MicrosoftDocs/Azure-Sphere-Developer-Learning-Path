...
#define LP_DEVICE_TWIN_HANDLER(name, deviceTwinBinding) \
	void name(LP_DEVICE_TWIN_BINDING *deviceTwinBinding)      \
	{

#define LP_DEVICE_TWIN_HANDLER_END \
	}

#define LP_DECLARE_DEVICE_TWIN_HANDLER(name) \
	void name(LP_DEVICE_TWIN_BINDING *deviceTwinBinding);
